...
MU_TEST(test_bzero_passing_two_bytes_and_size_two_should_set_all_to_null)
{
	// ARRANGE
	char	c[2] = {'a', 'b'};
	char	*s = &c[0];
...
MU_TEST(test_bzero_passing_two_bytes_and_size_zero_should_change_nothing)
{
	// ARRANGE
	char	c[2] = {'a', 'b'};
	char	*s = &c[0];
...
{
	MU_RUN_TEST(test_bzero_passing_one_byte_should_set_al_to_null);
	MU_RUN_TEST(test_bzero_passing_two_bytes_and_size_two_should_set_all_to_null);
	MU_RUN_TEST(test_bzero_passing_two_bytes_and_size_zero_should_change_nothing);
}
